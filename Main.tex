...
Todo grupo $G$ tal que existe  $X \in [G]^{<\omega}$ con 
...
\[
\mathrm{Tor}\!\left( \bigoplus_{G \in \mathcal{G}} G,\; C \right)
\;\cong\;
\bigoplus_{G \in \mathcal{G}} \mathrm{Tor}(G, C).
\]
\end{proposition}
...
\[
A \otimes C \;\cong\; \mathrm{Tor}(A, C).
\]
\end{proposition}
